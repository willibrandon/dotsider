...
public class HexSearchThresholdBenchmarks
{
    ...
    /// <summary>
    /// Payload size, in megabytes, parameterized to bracket the 8 ms adaptive search threshold.
    /// </summary>
    ...
    /// <summary>
    /// Allocates a random payload of SizeMB and prepares the no-match pattern for a worst-case scan.
    /// </summary>
    [GlobalSetup]
    public void Setup()
    {
    ...
    /// <summary>
    /// Measures the full-scan worst case that determines whether live-as-you-type search degrades at this size.
    /// </summary>
