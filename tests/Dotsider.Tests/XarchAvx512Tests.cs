...
public class XarchAvx512Tests
{
    ...
    [DataRow("vpaddd", "zmm0, zmm1, zmm2", new byte[] { 0x62, 0xF1, 0x75, 0x48, 0xFE, 0xC2 })]
    [DataRow("vpaddd", "zmm0{k1}, zmm1, zmm2", new byte[] { 0x62, 0xF1, 0x75, 0x49, 0xFE, 0xC2 })]
    [DataRow("vpternlogd", "zmm0, zmm1, zmm2, 0xff", new byte[] { 0x62, 0xF3, 0x75, 0x48, 0x25, 0xC2, 0xFF })]
    [DataRow("vpdpbusd", "zmm0, zmm1, zmm2", new byte[] { 0x62, 0xF2, 0x75, 0x48, 0x50, 0xC2 })]
    [DataRow("vpcmpd", "k1, zmm1, zmm2, 0x0", new byte[] { 0x62, 0xF3, 0x75, 0x48, 0x1F, 0xCA, 0x00 })]
    [DataRow("vscalefps", "zmm0, zmm1, zmm2", new byte[] { 0x62, 0xF2, 0x75, 0x48, 0x2C, 0xC2 })]
    [DataRow("vplzcntq", "zmm0, zmm1", new byte[] { 0x62, 0xF2, 0xFD, 0x48, 0x44, 0xC1 })]
    [DataRow("vpxord", "zmm0, zmm1, zmm2", new byte[] { 0x62, 0xF1, 0x75, 0x48, 0xEF, 0xC2 })]
    [DataRow("kmovw", "k1, k2", new byte[] { 0xC5, 0xF8, 0x90, 0xCA })]
    ...
    public void Decode_Evex_ZmmAndZeroing()
    {
        ...
        Assert.AreEqual("zmm0{k1}{z}, zmm1, zmm2", insn.OperandText);
    }
}
