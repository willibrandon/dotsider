...
exports.unknownBaselineComparison = unknownBaselineComparison;
...
async function enrichReports(jsonPath, markdownPath, source, comparison) {
...
function formatBaselineWarningMarkdown(source, comparison) {
    if (!comparison || comparison.status === "current")
        return undefined;
...
function unknownGuidance(reason, provider) {
    switch (reason) {
