...
public class PeMetadataViewTests(SampleAssemblyFixture samples) : IDisposable
{
    ...
    public async Task PeMetadata_NavigateToMethodDef()
    {
        ...
        await new Hex1bTerminalInputSequenceBuilder()
            ...
            .WaitUntil(_ => _state!.PeSubTab == PeSubTabId.TypeDef, TimeSpan.FromSeconds(5))
            .Key(Hex1bKey.RightArrow)
            .WaitUntil(_ => _state!.PeSubTab == PeSubTabId.MethodDef, TimeSpan.FromSeconds(5))
    ...
    public async Task PeMetadata_NavigateToTypeRef()
    {
        ...
        await new Hex1bTerminalInputSequenceBuilder()
            ...
            .Key(Hex1bKey.RightArrow)
            .WaitUntil(_ => _state!.PeSubTab == 1, TimeSpan.FromSeconds(5))
            .Key(Hex1bKey.RightArrow)
            .WaitUntil(_ => _state!.PeSubTab == 2, TimeSpan.FromSeconds(5))
            .Key(Hex1bKey.RightArrow)
            .WaitUntil(_ => _state!.PeSubTab == PeSubTabId.TypeRef, TimeSpan.FromSeconds(5))
    ...
    public async Task PeMetadata_NavigateToMemberRef()
    {
        ...
        await new Hex1bTerminalInputSequenceBuilder()
            ...
            .WaitUntil(_ => _state!.PeSubTab == 2, TimeSpan.FromSeconds(5))
            .Key(Hex1bKey.RightArrow)
            .WaitUntil(_ => _state!.PeSubTab == 3, TimeSpan.FromSeconds(5))
            .Key(Hex1bKey.RightArrow)
            .WaitUntil(_ => _state!.PeSubTab == PeSubTabId.MemberRef, TimeSpan.FromSeconds(5))
    ...
    public async Task PeMetadata_NavigateToAttributes()
    {
        ...
        await new Hex1bTerminalInputSequenceBuilder()
            ...
            .WaitUntil(_ => _state!.PeSubTab == 3, TimeSpan.FromSeconds(5))
            .Key(Hex1bKey.RightArrow)
            .WaitUntil(_ => _state!.PeSubTab == 4, TimeSpan.FromSeconds(5))
            .Key(Hex1bKey.RightArrow)
            .WaitUntil(_ => _state!.PeSubTab == PeSubTabId.Attributes, TimeSpan.FromSeconds(5))
    ...
    public async Task PeMetadata_NavigateToResources()
    {
        ...
        await new Hex1bTerminalInputSequenceBuilder()
            ...
            .WaitUntil(_ => _state!.PeSubTab == 4, TimeSpan.FromSeconds(5))
            .Key(Hex1bKey.RightArrow)
            .WaitUntil(_ => _state!.PeSubTab == 5, TimeSpan.FromSeconds(5))
            .Key(Hex1bKey.RightArrow)
            .WaitUntil(_ => _state!.PeSubTab == PeSubTabId.Resources, TimeSpan.FromSeconds(5))
