...
public class XarchCryptoTests
{
    ...
    [DataRow("aesenc", "xmm0, xmm1", new byte[] { 0x66, 0x0F, 0x38, 0xDC, 0xC1 })]
    [DataRow("aesenclast", "xmm0, xmm1", new byte[] { 0x66, 0x0F, 0x38, 0xDD, 0xC1 })]
    [DataRow("aesdec", "xmm0, xmm1", new byte[] { 0x66, 0x0F, 0x38, 0xDE, 0xC1 })]
    [DataRow("aesimc", "xmm0, xmm1", new byte[] { 0x66, 0x0F, 0x38, 0xDB, 0xC1 })]
    [DataRow("aeskeygenassist", "xmm0, xmm1, 0x1", new byte[] { 0x66, 0x0F, 0x3A, 0xDF, 0xC1, 0x01 })]
    [DataRow("pclmulqdq", "xmm0, xmm1, 0x11", new byte[] { 0x66, 0x0F, 0x3A, 0x44, 0xC1, 0x11 })]
    [DataRow("vaesenc", "xmm0, xmm1, xmm2", new byte[] { 0xC4, 0xE2, 0x71, 0xDC, 0xC2 })]
    [DataRow("vpclmulqdq", "xmm0, xmm1, xmm2, 0x10", new byte[] { 0xC4, 0xE3, 0x71, 0x44, 0xC2, 0x10 })]
    [DataRow("gf2p8mulb", "xmm0, xmm1", new byte[] { 0x66, 0x0F, 0x38, 0xCF, 0xC1 })]
    [DataRow("gf2p8affineqb", "xmm0, xmm1, 0x5", new byte[] { 0x66, 0x0F, 0x3A, 0xCE, 0xC1, 0x05 })]
