...
public class TuiArgParserTests
{
    ...
    public void Parse_FileOnly_ReturnsDefaults()
    {
        ...
        Assert.AreEqual("app.dll", result.FilePath);
        Assert.AreEqual(0, result.InitialTab);
        Assert.AreEqual(4, result.MinStringLength);
    }
    ...
    public void Parse_TabBeforeFile_ParsesTab()
    {
        ...
        Assert.AreEqual(2, result.InitialTab); // 1-indexed input, 0-indexed output
    }
    ...
    public void Parse_TabAfterFile_ParsesTab()
    {
        ...
        Assert.AreEqual(4, result.InitialTab);
    }
    ...
    public void Parse_ShortTabBeforeFile_ParsesTab()
    {
        ...
        Assert.AreEqual(1, result.InitialTab);
    }
    ...
    public void Parse_MinLenBeforeFile_ParsesMinLen()
    {
        ...
        Assert.AreEqual(10, result.MinStringLength);
    }
    ...
    public void Parse_ShortMinLenBeforeFile_ParsesMinLen()
    {
        ...
        Assert.AreEqual(8, result.MinStringLength);
    }
    ...
    public void Parse_AllOptionsBeforeFile_ParsesBoth()
    {
        ...
        Assert.AreEqual(3, result.InitialTab);
        Assert.AreEqual(12, result.MinStringLength);
    }
    ...
    public void Parse_MixedOrdering_ParsesBoth()
    {
        ...
        Assert.AreEqual(6, result.InitialTab);
        Assert.AreEqual(6, result.MinStringLength);
    }
    ...
    public void Parse_TabOutOfRange_Clamps()
    {
        ...
        Assert.AreEqual(7, high.InitialTab); // clamped to max (index 7 = tab 8)
        Assert.AreEqual(0, low.InitialTab);  // clamped to min (index 0 = tab 1)
    }
