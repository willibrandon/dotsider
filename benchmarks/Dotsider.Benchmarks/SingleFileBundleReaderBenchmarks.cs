...
public class SingleFileBundleReaderBenchmarks
{
    ...
    /// <summary>
    /// Publishes a self-contained bundle, pre-reads the bytes, and captures the bundle header offset.
    /// </summary>
    [GlobalSetup]
    public void Setup()
    {
    ...
    /// <summary>
    /// Negative case over a file stream: scans CoreLib without finding a bundle signature.
    /// </summary>
    ...
    /// <summary>
    /// Positive case over a file stream: locates the bundle signature in a real bundle.
    /// </summary>
    ...
    /// <summary>
    /// Negative case over a byte span: avoids file I/O to isolate scan cost.
    /// </summary>
    ...
    /// <summary>
    /// Positive case over a byte span: finds the bundle signature without touching disk.
    /// </summary>
    ...
    /// <summary>
    /// Parses the bundle manifest to enumerate every embedded assembly entry.
    /// </summary>
    ...
    /// <summary>
    /// End-to-end: locates the bundle, parses the manifest, and extracts the entry assembly bytes.
    /// </summary>
