...
public static class DiffTypesView
{
            ...
            widgets.Add(outer.Table(filtered)
                ...
                .Row((r, entry, rowState) =>
                {
                    ...
                    [
                        ...
                        r.Cell(c => c.ThemePanel(t => t.Set(GlobalTheme.ForegroundColor, fg).Set(GlobalTheme.BackgroundColor, bg), c.Text(TerminalText.Escape(type.BaseType ?? "")))),
    ...
    private static string KeyFor(DiffEntry<TypeDefInfo> entry) =>
